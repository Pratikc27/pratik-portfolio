...
/**
 * Inline SVG icons. These replace the previous raster icons (github.png,
 * mailicon.png) so they scale, inherit `currentColor`, cost no extra request,
 * and stay crisp on high-DPI screens.
 *
 * All are decorative by default — every icon on the site sits inside a link or
...
/** Maps the `icon` field in content/site.ts to a component. */
